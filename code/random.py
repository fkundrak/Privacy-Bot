...
for item in categories:
    ...
    class Ui_MainWindow(object):
        def run_bot(self):
            ...
            if uname != '' and pwd != '':
                me = scraper3.InstagramBot(uname, pwd)
                me.login()
                print("Logged in as " + uname)
                for hashtag in categories:
                    me.like_posts_in(categories)
                else:
        ...
        def setupUi(self, MainWindow):
            ...
            MainWindow.setTabOrder(self.password, self.submit_button)

        def retranslateUi(self, MainWindow):
            _translate = QtCore.QCoreApplication.translate
            MainWindow.setWindowTitle(_translate("MainWindow", "PEEP"))
            self.submit_button.setText(_translate("MainWindow", "Submit"))
            self.label.setText(_translate("MainWindow", "Instagram Save Bot"))
